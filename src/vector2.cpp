...
Vec2f::Vec2f(const Vec2& other) { x = (float) other.x; y = (float) other.y; }

Vec2f Vec2f::add(const Vec2f& other) const { return Vec2f(x + other.x, y + other.y); }
Vec2f Vec2f::sub(const Vec2f& other) const { return Vec2f(x - other.x, y - other.y); }
...
void Vec2f::operator+=(const Vec2f& other) { x += other.x; y += other.y; }
void Vec2f::operator-=(const Vec2f& other) { x -= other.x; y -= other.y; }
